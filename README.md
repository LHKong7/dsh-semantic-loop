...
| --- | --- |
| `semanticToolCalls` | All `semantic_checkpoint`, `semantic_state`, `semantic_capabilities`, `semantic_verify`, and `semantic_finish` calls; report separately as intervention overhead. |
